    ...
    <>
      <section className="hero-section relative">
        <img
          ...
          alt="Community Logo"
        />
        <div className="hero__text-wrap absolute  w-full  h-screen z-10">
          <aside className="top-1/2 absolute">
          ...
          <h1 className="text-[140px] ml-[4%] leading-none bottom-0 max-w-[1244px]  absolute font-[LuckiestGuy] text-white text-shadow-[0_0_50px_rgba(0,0,0,0.8)] inline-block">
